...
KafkaRPC.prototype.makeRequest = function (topic_name, content, callback) {
    ...
    var tId = setTimeout(function (corr_id) {
        ...
        //timely fashion
        console.log("kafkarpc.js", 'timeout');
    ...
    self.setupResponseQueue(self.producer, topic_name, function () {
        console.log("kafkarpc.js", 'in response');
        ...
        console.log("kafkarpc.js", 'in response1');
        console.log(self.producer.ready);
        self.producer.send(payloads, function (err, data) {
            console.log("kafkarpc.js", 'in response2');
            if (err)
                console.log(err);
            console.log(data);
        });
...
KafkaRPC.prototype.setupResponseQueue = function (producer, topic_name, next) {
    ...
    consumer.on('message', function (message) {
        console.log("kafkarpc.js", 'msg received');
    ...
    console.log("kafkarpc.js", 'returning next');
    return next();
};